...
void DXProceduralProject::BuildAccelerationStructures()
{
	...
	for (auto bottomLevelASIndex = 0; bottomLevelASIndex < BottomLevelASType::Count; bottomLevelASIndex++) {
		bottomLevelAS[bottomLevelASIndex] = BuildBottomLevelAS(geometryDescs[bottomLevelASIndex]);
	}
	...
	for (auto bottomLevelASIndex = 0; bottomLevelASIndex < BottomLevelASType::Count; bottomLevelASIndex++) {
		m_bottomLevelAS[bottomLevelASIndex] = bottomLevelAS[bottomLevelASIndex].accelerationStructure;
	}
