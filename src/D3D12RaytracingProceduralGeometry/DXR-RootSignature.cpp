...
void DXProceduralProject::CreateRootSignatures()
{
	...
	// Think of them as global function parameters.
	{
		...
		rootParameters[GlobalRootSignature::Slot::OutputView].InitAsDescriptorTable((UINT)1,ranges);
		rootParameters[GlobalRootSignature::Slot::AccelerationStructure].InitAsShaderResourceView(0);
		rootParameters[GlobalRootSignature::Slot::SceneConstant].InitAsConstantBufferView(0);
		rootParameters[GlobalRootSignature::Slot::AABBattributeBuffer].InitAsShaderResourceView(3);
		rootParameters[GlobalRootSignature::Slot::VertexBuffers].InitAsDescriptorTable((UINT)1,ranges+1);
