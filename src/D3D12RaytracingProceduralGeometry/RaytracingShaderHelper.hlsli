...
{
	float interpolant = elapsedTime % cycleDuration;
	float cycle = interpolant > 0.5 ? 1 - interpolant : interpolant;
	return smoothstep(0, 1, cycle);
}
