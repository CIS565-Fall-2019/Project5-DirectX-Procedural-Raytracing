//	LOOKAT-1.3:
//	* Holds all the DirectX abstractions: swapchain, command list, command queue etc..
//	* Allows initialization of such abstractions, and is used to execute command lists + synchronize with the GPU
//	* See: Prepare(), Present() ExecuteCommandList(), WaitForGpu()
...
namespace DX
{
    ...
    public:
		...
		// LOOKAT-1.3: these functions are called to execute the raytracing pipeline.
