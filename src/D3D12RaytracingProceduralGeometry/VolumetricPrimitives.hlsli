...
{	
	...
	else if (position_from_Center == 0.0f) {
		potential = 1.0f;
	}
	else if (position_from_Center < 1.0f )  {
		potential = 6*pow(position_from_Center,5.0f) - 15*pow(position_from_Center,4.0f) + 10*pow(position_from_Center,3.0f);
	}
